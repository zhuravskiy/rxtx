...
final public class RXTXPort extends SerialPort
{
	...
	*/
	...
	static
	{
        ...
        System.out.println(System.getProperty("rxtxLibraryPath"));
        try {
            System.loadLibrary(System.getProperty("rxtxLibraryName"));
        } catch (UnsatisfiedLinkError e) {
            System.out.println("Try to load " + System.getProperty("rxtxLibraryPath") + System.getProperty("rxtxLibraryName"));
            System.load(System.getProperty("rxtxLibraryPath") + System.getProperty("rxtxLibraryName"));
        }
		Initialize();
	}
